    ...
    <section className="text-gray-400 bg-gray-900 body-font">
      ...
      <Formik
        ...
        onSubmit={(values, { resetForm }) => {
          ...
          // Form işlemleri tamamlandıktan sonra formu temizle
          resetForm();
        }}
      >
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-col text-center w-full mb-12">
            ...
            <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
              Get in touch with us to discover how our cutting-edge solutions
              can revolutionize your digital experience and drive your success
            ...
            <Form>
              <div className="flex flex-wrap -m-2">
                ...
                <div className="p-2 w-full">
                  <button
                    type="submit"
                    className="flex mx-auto text-white bg-gradient-to-t to-purple-400 from-blue-400 border-0 py-2 px-8 focus:outline-none hover:bg-purple-600 rounded text-lg"
                  >
                    Button
                  </button>
                </div>
